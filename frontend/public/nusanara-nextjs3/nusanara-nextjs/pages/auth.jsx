            ...
            {!isRegister && (
              <div key="login" className="form-panel">
                ...
                <div style={{ display:'flex', flexDirection:'column', gap:18 }}>
                  ...
                  <button className="auth-btn-primary" style={{ marginTop:8 }} onClick={() => router.push('/dashboard')}>
                    Masuk ke Akun
                ...
                <button className="auth-btn-outline" onClick={() => router.push('/dashboard')}>
                  <GoogleIcon />
            ...
            {isRegister && (
              <div key="register" className="form-panel">
                ...
                <div style={{ display:'flex', flexDirection:'column', gap:16 }}>
                  ...
                  <button className="auth-btn-primary" style={{ marginTop:4 }} onClick={() => router.push('/dashboard')}>
                    Buat Akun Sekarang
                    <i data-lucide="arrow-right" style={{ width:16, height:16 }}></i>
                  </button>
                </div>
