...
\begin{itemize}
  ...
  \item \textbf{\texttt{--workers 2}:} Menjalankan 2 worker Uvicorn untuk
    menangani concurrent requests. Lebih dari 2 worker tidak disarankan karena
    setiap worker memuat model ke memori, dan Ollama sudah menangani
    \textit{concurrent inference} secara internal.
